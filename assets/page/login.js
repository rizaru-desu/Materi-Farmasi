...
export default class Login extends Component {
  ...
  sendPasswordReset = () => {
    if (this.state.userEmailForgot != "") {
      Axios.post(`https://farmasi-apps.herokuapp.com/reset`, {
            ...
            >
              <Text
                style={{
                  ...
                  color: this.state.active === 0 ? "#4662BC" : "black",
                }}
              >
                Register
              </Text>
            ...
            >
              <Text
                style={{
                  ...
                  textAlign: "center",
                  fontFamily: "Montserrat-Bold",
                  color: this.state.active === 1 ? "#4662BC" : "black",
                }}
              >
                Sign In
              </Text>
          ...
          >
            ...
            >
              ...
              <Button
                ...
                buttonStyle={{ backgroundColor: "#4662BC" }}
                titleStyle={{
                  color: "white",
                  fontSize: hp("2%"),
