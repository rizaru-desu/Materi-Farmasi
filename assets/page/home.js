...
export default class Home extends Component {
  constructor(props) {
    ...
    this.interstitialAdId =
      Platform.OS === "ios" ? null : "ca-app-pub-9341343436751788/1074884078";
    this.bannerAdId =
      Platform.OS === "ios" ? null : "ca-app-pub-9341343436751788/2491358780";
  ...
  _getMenu = () => {
    axios
      .post(`https://farmasi-apps.herokuapp.com/API-MKEP`, {
        nameJSON: "menu.json",
      })
      .then((res) => {
                  ...
                  source={{
                    uri:
                      this.state.displayProfile === null
                        ? "https://firebasestorage.googleapis.com/v0/b/materi-farmasi.appspot.com/o/data%2Fpills.png?alt=media&token=f5cff2da-db05-4010-a5a2-578fef7c8b2f"
